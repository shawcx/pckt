...
PyMODINIT_FUNC PyInit_pcap() {
    ...
    pypcap_error = PyErr_NewException("pckt.pcap.error", NULL, NULL);
    ...
    // PCAP DIRECTIONS
    PyModule_AddIntConstant(mod, "IN",    PCAP_D_IN);
    PyModule_AddIntConstant(mod, "OUT",   PCAP_D_OUT);
    PyModule_AddIntConstant(mod, "INOUT", PCAP_D_INOUT);
